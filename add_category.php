...
<body>
	   ...
	   <nav id="nav-wrap"> 
	   	...
	   	<div class="row">    		            
			   	...
			   	<ul id="nav" class="nav">
			      	...
			      	<li><a href="page.html">A PROPOS</a></li>
			   	</ul> <!-- end #nav -->			   	 
   ...
   <div id="content-wrap">
     ...
     ?>
				...
				<div class="widget widget_text group">
					<h3>CITATION QUOTIDIENNE DU JOUR</h3>
   				<p>Qu'est-ce que le succès ?</p><br/>
   ...
   <footer>
      ...
      <div class="row"> 
         ...
         <p class="copyright">&copy; Copyright 2021. The Blog. &nbsp; Design by <a title="Styleshout" href="http://www.styleshout.com/">Styleshout</a>.</p>
